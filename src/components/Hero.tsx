      ...
      <section className="bg-bg-primary h-auto ">
        <div className="max-w-5xl mx-auto py-10 px-6 flex justify-between">
          <div>
            ...
            <button className="mt-4 bg-hover-button transition-colors ease-in-out duration-300 p-4 rounded-md text-font-primary font-medium hover:bg-font-hero cursor-pointer">
              Quero garantir o meu ebook agora
            </button>
          </div>
          <div>
            <img className="max-w-sm" src={CapaLivro} />
          </div>
        </div>
